...
@mainbp.route('/')
def index():
    tag_line='test string'
    hotels123 = get_hotel_list()
    return render_template('index_static.html', tag_line=tag_line, hotels=hotels123)
    #return render_template('index_list.html', tag_line=tag_line, hotels=hotels123)
